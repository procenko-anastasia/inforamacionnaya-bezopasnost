...
```
git clone https://gitflic.ru/project/verter_ds/inforamacionnaya-bezopasnost.git
cd inforamacionnaya-bezopasnost
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/verter_ds/inforamacionnaya-bezopasnost.git
git clone
